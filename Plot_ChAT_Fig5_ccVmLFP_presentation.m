...
spont_cc_On_f80_pos(1,:) = [0.08 , spont_trace_On_f80_pos(6,2)-0.16 , 0.15 , 0.08];
...
annotation('textbox', [evoked_trace_Off_f80_pos(1,1) evoked_trace_Off_f80_pos_top 0 0]+[0.07 0 0.5 0.05],...
