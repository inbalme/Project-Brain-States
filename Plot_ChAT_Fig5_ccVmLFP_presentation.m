...
%evoked
evoked_trace_Off_f80 = open('Vm-LFP_evoked_stim1_Off_f80_t2  3  4.fig');    
evoked_trace_Off_f80_ax = get(gcf, 'children');

evoked_trace_On_f80 = open('Vm-LFP_evoked_stim1_On_f80_t2  3  4.fig');    
...
%% Positions:
spont_trace_Off_f80_pos(1,:) = [0.05 , 0.9 , 0.43 , 0.05];
...
spont_cc_On_f80_pos(1,:) = [0.08 , spont_trace_On_f80_pos(6,2)-0.13 , 0.15 , 0.08];
spont_cc_Off_f80_pos(1,:) = [0.08 , 0.5 , 0.15 , 0.08]; spont_cc_Off_f80_pos(1,2)=spont_cc_On_f80_pos(1,2)-spont_cc_Off_f80_pos(1,4)-0.05;
...
h_dist2=spont_cc_Off_f80_pos(1,1)+spont_cc_Off_f80_pos(1,3)+0.05;
evoked_cc_On_f80_pos(1,:) = [h_dist2 , spont_cc_On_f80_pos(1,2) ,  spont_cc_On_f80_pos(1,3) ,  spont_cc_On_f80_pos(1,4)];
evoked_cc_Off_f80_pos(1,:) = [h_dist2 , spont_cc_Off_f80_pos(1,2) , evoked_cc_On_f80_pos(1,3) ,  spont_cc_Off_f80_pos(1,4)];
...
h_dist3=h_dist2+evoked_cc_Off_f80_pos(1,3)+0.16;
cc_paired_plot_pos(1,:) = [h_dist3 , evoked_cc_Off_f80_pos(1,2)-0.03 , 0.15 , 0.2];  
...
set(evoked_trace_Off_f80_ax_copy(1),'position',[0.92 evoked_trace_Off_f80_pos_top-0.01 0.08 0.05])
evoked_trace_Off_f80_ax_copy(1).FontSize=11;
evoked_trace_Off_f80_ax_copy(1).LineWidth=1.5;  
%  
...
%position legend
set(evoked_trace_On_f80_ax_copy(1),'position',[0.92 evoked_trace_On_f80_pos_top-0.01 0.08 0.05]) 
evoked_trace_On_f80_ax_copy(1).FontSize=11;
evoked_trace_On_f80_ax_copy(1).LineWidth=1.5;  
 %%
...
set(spont_cc_Off_f80_ax_copy(1),'position',spont_cc_Off_f80_pos(1,:))
    set(F, 'currentaxes', spont_cc_Off_f80_ax_copy(1));  
...
%position legend:
set(evoked_cc_Off_f80_ax_copy(1),'position',[evoked_cc_Off_f80_pos(1,1)+evoked_cc_Off_f80_pos(1,3), evoked_cc_Off_f80_pos_top-0.03 0.08 0.05]) 
...
set(evoked_cc_On_f80_ax_copy(2),'position',evoked_cc_On_f80_pos(1,:),'xticklabel',[])
   set(F, 'currentaxes', evoked_cc_On_f80_ax_copy(2)); yl=ylabel(''); xl=xlabel('');  
   evoked_cc_On_f80_ax_copy(2).FontSize=12;
   %position legend
 set(evoked_cc_On_f80_ax_copy(1),'position',[evoked_cc_On_f80_pos(1,1)+evoked_cc_On_f80_pos(1,3)+0.01, evoked_cc_On_f80_pos_top-0.03 0.08 0.05]) 
evoked_cc_On_f80_ax_copy(1).FontSize=11;
evoked_cc_On_f80_ax_copy(1).LineWidth=1.5;

%   annotation:
annotation('textbox', [spont_trace_Off_f80_pos(1,1) spont_trace_Off_f80_pos_top 0 0]+[0.1 0 0.5 0.05],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'Spontaneous Activity', 'FontName','arial', 'fontsize', 14, 'fontweight', 'bold')
annotation('textbox', [evoked_trace_Off_f80_pos(1,1) evoked_trace_Off_f80_pos_top 0 0]+[0.12 0 0.5 0.05],...
...
annotation('textbox', [spont_trace_Off_f80_pos(1,1) spont_trace_Off_f80_pos_top 0 0]+a_pos3,...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'A', 'FontName','arial', 'fontsize', 12, 'fontweight', 'bold')
 annotation('textbox', [spont_trace_On_f80_pos(1,1) spont_trace_On_f80_pos_top 0 0]+a_pos4,...
 ...
 annotation('textbox', [spont_cc_Off_f80_pos(1,1) spont_cc_Off_f80_pos_top 0 0]+a_pos3,...
 ...
 annotation('textbox', [evoked_cc_Off_f80_pos(1,1) evoked_cc_Off_f80_pos_top 0 0]+a_pos3,...
 ...
 annotation('textbox', [spont_trace_Off_f80_pos(1,1) spont_trace_Off_f80_pos_top 0 0]+[0.08 -0.02 0.1 0.04],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'NB-', 'FontName','arial', 'fontsize', 12, 'color', [0 0 153]/256)
 annotation('textbox', [spont_trace_On_f80_pos(1,1) spont_trace_On_f80_pos_top 0 0]+[0.08 -0.02 0.1 0.04],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'NB+', 'FontName','arial', 'fontsize', 12, 'color', [0 0 153]/256)
%  
