...
%traces:
traces_depth1 = open('f46_traces_x1_v2.fig');    
traces_depth1_ax = get(gcf, 'children');

cd 'D:\Inbal M.Sc\Data PhD\NB-ES Data\Figures\Vm Histograms and Powerspec\Powerspec Vm';
%PSD
PSD_depth1 = open('f46_Vm_power_spectrum.fig');   
PSD_depth1_ax = get(gcf, 'children');

cd 'D:\Inbal M.Sc\Data PhD\NB-ES Data\Figures\Vm Histograms and Powerspec\Powerspec Vm\Not Normalized';
%normalized power
