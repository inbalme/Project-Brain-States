...
switch exp_type
    case 1
        files_to_analyze =44; %[8,10,11,12,14,15,16,22,36,37,40,1,44,46,48,50,52,56,58,62,72,75,82,84]; %[44,46,48,52,56,58,62,72,75,82,84]; %[8,10,11,12,14,15,16,22,36,37,40,1,44,46,48,50,52,56,58,62,72,75,82,84]; 
...
for t=1:length(start_time)
 ...
 if strcmp(data_type,'LFP')
   ...
   ylim([0 10])
     y1tick=[10e-4, 10e-3, 10e-2,10e-1,10e0];  
 end
        set(gca,'xscale','log');
        set(gca,'yscale','log');
