...
evoked_trace_Off_f80 = open('f80_traces_x2_v2.fig');    
evoked_trace_Off_f80_ax = get(gcf, 'children');

evoked_trace_On_f80 = open('f80_traces_x3_v2.fig');    
evoked_trace_On_f80_ax = get(gcf, 'children');

evoked_mean_f80 = open('f80_mean_x2+3_v2.fig');    
evoked_mean_f80_ax = get(gcf, 'children');

evoked_std_f80 = open('f80_std_x2+3_mean-subt_v2.fig');    
evoked_std_f80_ax = get(gcf, 'children');
...
cd 'D:\Inbal M.Sc\Data PhD\ChAT Data\Figures\Traces+std+mean+summary\LFP_50Hz Vm_50Hz+BP'
...
%% Positions:
spont_trace_f80_pos(1,:) = [0.05 , 0.79 , 0.2 , 0.13];
h_dist1=spont_trace_f80_pos(1,1)+spont_trace_f80_pos(1,3)+0.03;
spont_mean_f80_pos(1,:) = [h_dist1 , spont_trace_f80_pos(1,2) ,  spont_trace_f80_pos(1,3) ,  spont_trace_f80_pos(1,4)];
h_dist2=spont_mean_f80_pos(1,1)+spont_mean_f80_pos(1,3)+0.03;
spont_std_f80_pos(1,:) =[h_dist2 , spont_mean_f80_pos(1,2) ,  spont_mean_f80_pos(1,3) ,  spont_mean_f80_pos(1,4)];
    
v_dist=0.05;
evoked_trace_Off_f80_pos(1,:) = [spont_trace_f80_pos(1,1)-0.01 , spont_trace_f80_pos(1,2)-spont_trace_f80_pos(1,4)-0.08 ,  0.25 ,  spont_trace_f80_pos(1,4)];
evoked_trace_On_f80_pos(1,:) = [evoked_trace_Off_f80_pos(1,1), evoked_trace_Off_f80_pos(1,2)-evoked_trace_Off_f80_pos(1,4)-v_dist, evoked_trace_Off_f80_pos(1,3), evoked_trace_Off_f80_pos(1,4)];
evoked_mean_f80_pos(1,:) = [evoked_trace_Off_f80_pos(1,1), evoked_trace_On_f80_pos(1,2)-evoked_trace_On_f80_pos(1,4)-v_dist, evoked_trace_Off_f80_pos(1,3), evoked_trace_Off_f80_pos(1,4)];
evoked_std_f80_pos(1,:) = [evoked_trace_Off_f80_pos(1,1), evoked_mean_f80_pos(1,2)-evoked_mean_f80_pos(1,4)-v_dist, evoked_trace_Off_f80_pos(1,3), evoked_trace_Off_f80_pos(1,4)];

h_dist3=evoked_trace_Off_f80_pos(1,1)+evoked_trace_Off_f80_pos(1,3)+0.02;

evoked_trace_Off_f80_zoom_pos(1,:) = [h_dist3, evoked_trace_Off_f80_pos(1,2) ,  0.4 ,  evoked_trace_Off_f80_pos(1,4)];
evoked_trace_On_f80_zoom_pos(1,:) = [h_dist3, evoked_trace_On_f80_pos(1,2) ,  0.4 ,  evoked_trace_Off_f80_pos(1,4)];
evoked_mean_f80_zoom_pos(1,:) = [h_dist3, evoked_mean_f80_pos(1,2) ,  0.4 ,  evoked_trace_Off_f80_pos(1,4)];
evoked_std_f80_zoom_pos(1,:) = [h_dist3, evoked_std_f80_pos(1,2) ,  0.4 ,  evoked_trace_Off_f80_pos(1,4)];

h_dist4=evoked_std_f80_zoom_pos(1,1)+evoked_std_f80_zoom_pos(1,3)+0.08;
v_dist2=0.03;
VmM_pos(1,:)=[h_dist4, spont_trace_f80_pos(1,2)+0.02, 0.14, 0.12];
...
evoked_mean_f80_pos_top = evoked_mean_f80_pos(1,2)+evoked_mean_f80_pos(1,4);
evoked_std_f80_pos_top = evoked_std_f80_pos(1,2)+evoked_std_f80_pos(1,4);
...
set(spont_mean_f80_ax_copy,'position',spont_mean_f80_pos(1,:))
...
set(evoked_trace_Off_f80_ax_copy,'position',evoked_trace_Off_f80_pos(1,:))

evoked_trace_On_f80_ax_copy = copyobj(evoked_trace_On_f80_ax,F); % copy axes to new fig
set(evoked_trace_On_f80_ax_copy,'position',evoked_trace_On_f80_pos(1,:))

evoked_mean_f80_ax_copy = copyobj(evoked_mean_f80_ax,F); % copy axes to new fig
set(evoked_mean_f80_ax_copy,'position',evoked_mean_f80_pos(1,:))

evoked_std_f80_ax_copy = copyobj(evoked_std_f80_ax,F); % copy axes to new fig
set(evoked_std_f80_ax_copy,'position',evoked_std_f80_pos(1,:))
...
% set(evoked_mean_f80_zoom_ax_copy(1),'position',[0.9 spont_std_f80_pos_top+0.01 0.08 0.05])
% evoked_mean_f80_zoom_ax_copy(1).FontSize=11;
% evoked_mean_f80_zoom_ax_copy(1).LineWidth=1.5;  
%   annotation:
annotation('textbox', [spont_trace_f80_pos(1,1) spont_trace_f80_pos_top 0 0]+[0.06 0.01 0.5 0.05],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'Spontaneous Activity', 'FontName','arial', 'fontsize', 14, 'fontweight', 'bold')
annotation('textbox', [evoked_trace_Off_f80_pos(1,1) evoked_trace_Off_f80_pos_top 0 0]+[0.06 0.01 0.5 0.05],...
...
annotation('textbox', [evoked_trace_Off_f80_pos(1,1) evoked_trace_Off_f80_pos_top 0 0]+a_pos4,...
    'FitHeightToText', 'on', 'edgecolor', 'none','string', 'D', 'FontName','arial', 'fontsize', 12, 'fontweight', 'bold')
annotation('textbox', [evoked_trace_On_f80_pos(1,1) evoked_trace_On_f80_pos_top 0 0]+a_pos4,...
    'FitHeightToText', 'on', 'edgecolor', 'none','string', 'E', 'FontName','arial', 'fontsize', 12, 'fontweight', 'bold')
annotation('textbox', [evoked_mean_f80_pos(1,1) evoked_mean_f80_pos_top 0 0]+a_pos4,...
    'FitHeightToText', 'on', 'edgecolor', 'none','string', 'F', 'FontName','arial', 'fontsize', 12, 'fontweight', 'bold')
annotation('textbox', [evoked_std_f80_pos(1,1) evoked_std_f80_pos_top 0 0]+a_pos4,...
...
annotation('textbox', [evoked_mean_f80_zoom_pos(1,1) evoked_mean_f80_zoom_pos_top 0 0]+a_pos2,...
    'FitHeightToText', 'on', 'edgecolor', 'none','string', 'J', 'FontName','arial', 'fontsize', 12, 'fontweight', 'bold')
annotation('textbox', [evoked_std_f80_zoom_pos(1,1) evoked_std_f80_zoom_pos_top 0 0]+a_pos2,...
...
if save_flag==1
    filename='Fig 3 ChAT intracellular traces+SNR_f80';
