...
v_dist=0.04;
spont_trace_f80_pos(1,:) = [0.04 , 0.63 ,  0.42 ,  0.25];
...
h_dist1=spont_trace_f80_pos(1,1)+spont_trace_f80_pos(1,3)+0.06;
...
set(VmM_ax_copy(1),'position',[0.9 evoked_trace_Off_f80_zoom_pos_top+0.02 0.08 0.04])
...
annotation('textbox', [evoked_trace_Off_f80_zoom_pos(1,1) evoked_trace_Off_f80_zoom_pos_top 0 0]+[0.06 0.01 0.5 0.05],...
