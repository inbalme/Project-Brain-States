%% Analyze ChAT_response_parameters_10_20Hz_v2
% This file was created on 19/12/2016 
...
%       protocol 10 (ChAT:galvnao train+test (3 x-values))
%                 11 - ChAT: 3 currents+galvano train+test (6 x-values)
...
%% visualizing raw data traces for ongoing and evoked light off and light on together  
%  figure
%  hold on
