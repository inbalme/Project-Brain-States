function Extract_ChAT_Data_v2
% function Extract_ChAT_Data_v2 forms the database 'Extracted Data' used by
...
files = Get_ChAT_Files_v2();

for fileind = 37; %54:length(files) % analyzing files that were not yet saved.
...
%             block info
    ...
    Param.sub_type                  = Exp.Header(run_header).headerInfo.subexp_type;
      ...
      Param.facade_name             = {''; 'board'; 'channel'; 'waveform'; 'delay'; ''; 'amp'; 'on_duration'; 'cycles'; ''; ''; ''; ''; ''; 'board'; 'channel'; 'waveform'; 'delay'; ''; 'amp'; 'on_duration'; 'cycles'; ''; ''; ''; ''; ''};
        else if strcmp('Whisker_Stim', Param.exp_type); 
