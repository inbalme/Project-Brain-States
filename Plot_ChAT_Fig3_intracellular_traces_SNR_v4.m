...
v_dist=0.04;
spont_trace_f80_pos(1,:) = [0.04 , 0.72 ,  0.44 ,  0.20];
...
evoked_trace_Off_f80_zoom_pos(1,:) = [h_dist1, spont_trace_f80_pos(1,2)+0.1 ,  0.48 ,  0.12];
...
evoked_mean_f80_zoom_pos(1,:) = [h_dist1, evoked_trace_On_f80_zoom_pos(1,2)-0.10-0.03 ,   evoked_trace_Off_f80_zoom_pos(1,3) ,   0.10];
...
v_dist2=0.05;
VmM_pos(1,:)=[0.08, 0.5, 0.14, 0.10]; VmM_pos(1,2)=evoked_std_f80_zoom_pos(1,2)-VmM_pos(1,4)-v_dist2;
...
%position legend:
set(VmM_ax_copy(1),'position',[0.89 evoked_trace_Off_f80_zoom_pos_top+0.03 0.08 0.005])
