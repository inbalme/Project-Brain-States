...
%traces:
traces_depth1 = open('f76_traces_x1_LFP.fig');    
traces_depth1_ax = get(gcf, 'children');

cd 'D:\Inbal M.Sc\Data PhD\ChAT Data\Figures\Vm Histograms and Powerspec\Powerspec LFP';
%PSD
PSD_depth1 = open('f76_LFP_power_spectrum.fig');   
...
total_power_pos(1,:) = [0.07 , 0.5 , 0.1 , 0.22]; total_power_pos(1,2)=traces_depth1_pos(1,2)-total_power_pos(1,4)-0.18;
