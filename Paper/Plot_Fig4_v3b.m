...
v_dist=0.12;
VmM_pos(1,:)=[0.07, 0.68, 0.1, 0.12]; 
VmSTD_pos(1,:)= VmM_pos; VmSTD_pos(1,1)=VmM_pos(1,1)+VmM_pos(1,3)+0.07;
Peak_amp_pos(1,:)=[VmM_pos(1,1),0.5, 0.3, 0.25 ]; Peak_amp_pos(1,2)=VmM_pos(1,2)-Peak_amp_pos(1,4)-v_dist;
...
NB_illustration_pos(1,:)=[VmM_pos(1,1)+0.08,VmM_pos_top+0.07, 0.11, 0.12];
ChAT_illustration_pos(1,:)=[VmM_ChAT_pos(1,1)+0.08,VmM_ChAT_pos_top+0.07, NB_illustration_pos(1,3), NB_illustration_pos(1,4)];
...
annotation('textbox', [Peak_amp_pos(1,1)+0.05, Peak_amp_pos_top+0.005, 0.2, 0.04],...
    'FitHeightToText', 'on', 'edgecolor', 'none','string', 'Response Amplitude', 'FontName','arial', 'fontsize', 12)
