...
evoked_mean_f80_zoom_ax_copy(1).FontSize=9;
 ...
 a_pos2=[-0.02 -0.04 0.04 0.04]; %[-0.02 0.01 0.04 0.04]
 ...
 annotation('textbox', [f80_WS_pos(1,1) f80_WS_pos_top 0 0]+a_pos3,...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'WS', 'FontName','arial', 'fontsize', 12) %'fontweight', 'bold'
 annotation('textbox', [evoked_trace_Off_f46_zoom_pos(1,1)-0.005 evoked_trace_Off_f46_zoom_pos_top 0 0]+a_pos4,...
...
annotation('textbox', [evoked_trace_On_f80_zoom_pos(1,1) evoked_trace_On_f46_zoom_pos_top 0 0]+a_pos2,...
    'FitHeightToText', 'on', 'edgecolor', 'none','string', 'F', 'FontName','arial', 'fontsize', 10, 'fontweight', 'bold')
annotation('textbox', [evoked_mean_f80_zoom_pos(1,1) evoked_mean_f46_zoom_pos_top 0 0]+a_pos2,...
    'FitHeightToText', 'on', 'edgecolor', 'none','string', 'G', 'FontName','arial', 'fontsize', 10, 'fontweight', 'bold')
annotation('textbox', [evoked_std_f80_zoom_pos(1,1) evoked_std_f46_zoom_pos_top 0 0]+a_pos2,...
