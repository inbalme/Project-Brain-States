...
cd 'D:\Inbal M.Sc\Data PhD\NB-ES Data\Figures\single trial analysis\Spontaneous\detection f46'
     color_onset=[255,178,102]./256; color_top=[255,153,16]./256;
        ...
        set(a(1),'xdata',linexdata-50/1000,'linewidth',barWidth);
        delete(a(2));
...
if no_numbering_flag==0;
 annotation('textbox', [detection_example1_pos(1,1)-0.07, detection_example1_pos_top+0.02 0 0],...
...
%      'FitHeightToText', 'on', 'edgecolor', 'none','string', 'B', 'FontName','arial', 'fontsize', 10, 'fontweight', 'bold')
 annotation('textbox', [detection_example1_ChAT_pos(1,1)-0.07, detection_example1_pos_top+0.02 0 0],...
...
%      'FitHeightToText', 'on', 'edgecolor', 'none','string', 'D', 'FontName','arial', 'fontsize', 10, 'fontweight', 'bold') 
 annotation('textbox', [detection_example1_pos(1,1)-0.07, spont_amp_hist_pos_top+0.05 0 0],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'B', 'FontName','arial', 'fontsize', letter_fontsize, 'fontweight', 'bold')
 annotation('textbox', [detection_example1_pos(1,1)-0.07 spont_event_freq_pos_top+0.05 0 0],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'C', 'FontName','arial', 'fontsize', letter_fontsize, 'fontweight', 'bold')
 annotation('textbox', [spont_event_amp_pos(1,1)-0.09 spont_event_freq_pos_top+0.05 0 0],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'D', 'FontName','arial', 'fontsize', letter_fontsize, 'fontweight', 'bold')
  annotation('textbox', [detection_example1_ChAT_pos(1,1)-0.07, spont_amp_hist_ChAT_pos_top+0.05 0 0],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'F', 'FontName','arial', 'fontsize', letter_fontsize, 'fontweight', 'bold')
 annotation('textbox', [detection_example1_ChAT_pos(1,1)-0.07 spont_event_freq_pos_top+0.05 0 0],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'G', 'FontName','arial', 'fontsize', letter_fontsize, 'fontweight', 'bold')
 annotation('textbox', [spont_event_amp_ChAT_pos(1,1)-0.09 spont_event_freq_pos_top+0.05 0 0],...
...
if save_flag==1   
    filename='Fig4_f46_f80_v3';
    saveas(F,filename,'fig'); 
    print(F,filename,'-dpng','-r600','-opengl') 
    print -depsc2 Fig4_f46_f80_v3
