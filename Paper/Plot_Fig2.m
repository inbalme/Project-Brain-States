...
% 
% %NB
% spont_Vm_hist_pos(1,:)=[0.2 , 0.5 ,  0.27 ,  0.12]; spont_Vm_hist_pos(1,2)=spont_std_f46_pos(1,2)-spont_Vm_hist_pos(1,4)-0.08;
% h_dist1=spont_Vm_hist_pos(1,1)+spont_Vm_hist_pos(1,3)+0.16;
% spont_Vm_5prcentile_pos(1,:) = [h_dist1 , spont_Vm_hist_pos(1,2)-0.04 ,  0.1 ,  0.18];
% spont_Rin_pos(1,:) = [h_dist1+spont_Vm_5prcentile_pos(1,3)+0.12, spont_Vm_5prcentile_pos(1,2) ,  spont_Vm_5prcentile_pos(1,3) ,  spont_Vm_5prcentile_pos(1,4)];
% 
% v_dist2=0.1;
% VmM_NB_pos(1,:)=[spont_Rin_pos(1,1), spont_trace_f46_pos(1,2)+0.08, 0.1, 0.18]; 
% VmSTD_NB_pos(1,:)= VmM_NB_pos; VmSTD_NB_pos(1,2)=VmM_NB_pos(1,2)-VmM_NB_pos(1,4)-0.14;
% 
% NB_illustration_pos(1,:)=[0.5,spont_trace_f46_pos(1,2)+spont_trace_f46_pos(1,4)+0.02, 0.11, 0.1];
...
%   
% if save_flag==1
%     filename='Fig 2 intracellular traces spont_f46_f80_v3';
%     saveas(F,filename,'fig'); 
%     print(F,filename,'-dpng','-r600','-opengl') 
%     print(F, '-depsc2', filename);
% end
