...
spont_trace_Off_f80_ax = get(gcf, 'children');
        ...
        set(line1(6),'xdata',linexdata-120,'linewidth',barWidth);
...
spont_trace_On_f80_ax = get(gcf, 'children');
        ...
        set(line2(6),'xdata',linexdata-120,'linewidth',barWidth,'color',[0, 0, 0.7969]);
...
evoked_trace_On_f80_ax = get(gcf, 'children');
        ...
        set(line2(39),'xdata',linexdata-60,'linewidth',barWidth,'color',[0, 0, 0.7969]);
...
%% Positions:
spont_trace_Off_f80_pos(1,:) = [0.04 , 0.87 , 0.43 , 0.06];
...
spont_trace_Off_f80_pos(2*i+1,:) = spont_trace_Off_f80_pos(2*i,:)-[0 , spont_trace_Off_f80_pos(2*i,4)+0.02 , 0 , 0];
end
...
spont_trace_On_f80_pos(2*i+1,:) = spont_trace_On_f80_pos(2*i,:)-[0 , spont_trace_On_f80_pos(2*i,4)+0.02 , 0 , 0];
end


h_dist1=spont_trace_Off_f80_pos(1,1)+spont_trace_Off_f80_pos(1,3)+0.06;
...
evoked_trace_Off_f80_pos(2*i+1,:) = evoked_trace_Off_f80_pos(2*i,:)-[0 , evoked_trace_Off_f80_pos(2*i,4)+0.02 , 0 , 0];
end
...
evoked_trace_On_f80_pos(2*i+1,:) = evoked_trace_On_f80_pos(2*i,:)-[0 , evoked_trace_On_f80_pos(2*i,4)+0.02 , 0 , 0];
end

spont_cc_On_f80_pos(1,:) = [0.105 , spont_trace_On_f80_pos(6,2)-0.12 , 0.125 , 0.05]; %shuffled
...
h_dist3=spont_cc_Off_f80_pos(1,1)+spont_cc_Off_f80_pos(1,3)+0.18;
...
cc_paired_plot_shuff_pos(1,:) = [0.105 , evoked_cc_Off_f80_pos(1,2)-0.19 , 0.27 , 0.09]; 
...
set(evoked_trace_Off_f80_ax_copy(1),'position',[0.92 evoked_trace_Off_f80_pos_top 0.08 0.04])
...
annotation('textbox', [evoked_trace_Off_f80_pos(1,1) evoked_trace_Off_f80_pos_top 0 0]+[0.03 0.02 0.5 0.05],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'Sensory-evoked Responses', 'FontName','arial', 'fontsize', 12)
...
annotation('textbox', [spont_trace_Off_f80_pos(1,1)-0.03 spont_trace_Off_f80_pos_top+0.04 0 0],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'A', 'FontName','arial', 'fontsize', letter_fontsize, 'fontweight', 'bold')
 annotation('textbox', [spont_trace_On_f80_pos(1,1)-0.03 spont_trace_On_f80_pos_top+0.04 0 0],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'B', 'FontName','arial', 'fontsize', letter_fontsize, 'fontweight', 'bold')
 annotation('textbox', [evoked_trace_Off_f80_pos(1,1)-0.02 evoked_trace_Off_f80_pos_top+0.04 0 0],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'C', 'FontName','arial', 'fontsize', letter_fontsize, 'fontweight', 'bold')
 annotation('textbox', [evoked_trace_On_f80_pos(1,1)-0.02 evoked_trace_On_f80_pos_top+0.04 0 0],...
