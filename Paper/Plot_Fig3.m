...
set(rec,'FaceColor',rectangle_color);
...
%position legend:
set(spont_mean_f80_ax_copy(1),'position',[0.6 spont_trace_f80_pos_top 0.08 0.005])
...
yl=ylabel({'5%-ile (mV)'},'fontsize',ax_fontsize);
...
if save_flag==1
    filename='Fig3_intracellular_traces spont_f80_v2';
    saveas(F,filename,'fig'); 
    print(F,filename,'-dpng','-r600','-opengl') 
    print -depsc2 Fig3_intracellular_traces_spont_f80_v2
